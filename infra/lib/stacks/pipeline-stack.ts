  ...
  constructor(scope: Construct, id: string, props: PipelineStackProps) {
    ...
    const synth = new pipelines.ShellStep("Synth", {
      ...
      commands: [
        ...
        // Quality checks - only unit tests (lint not available)
        "npm run test",
    ...
    // Deploy production frontend stack
    const deployStage = new cdk.Stage(this, "Deploy", {
      env: { account: this.account, region: this.region },
    });
    new FrontendStack(deployStage, "CoreUIFrontend-prod", {
      stackName: "CoreUIFrontend-prod",
      environment: "prod",
      buildOutputPath: "../dist/coreui-free-angular-admin-template/browser",
    });
