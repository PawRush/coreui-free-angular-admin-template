...
const branchName = app.node.tryGetContext("branchName") || "deploy-to-aws-20260129_231512-sergeyka";

// Manual deployment mode (preview environments)
...
// Pipeline deployment mode (automated prod deployments)
if (codeConnectionArn) {
  new PipelineStack(app, "CoreUIPipelineStack", {
    env: { account, region },
    description: "CI/CD Pipeline for CoreUI",
    codeConnectionArn,
    repositoryName,
    branchName,
